...
public class RedisConfig {
    ...
    @Bean
    public ReactiveRedisTemplate<String, Operacao> reactiveRedisTemplate(ReactiveRedisConnectionFactory factory) {
        Jackson2JsonRedisSerializer<Operacao> serializer = new Jackson2JsonRedisSerializer<>(Operacao.class);
